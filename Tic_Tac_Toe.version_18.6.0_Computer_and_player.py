...
def automated_move (current_player):
    if line_1[0] == current_player and line_1[1] == current_player and "3" not in what_is_actually_in_field:
        ...
        applying_automated_move(current_player,"3")
        ...
        applying_automated_move(current_player,"3")
    else:# Napisać funkcję ktora zwroci wartosć pola ktore da wygraną lub zwroci None. Automated move powinna korzystac
