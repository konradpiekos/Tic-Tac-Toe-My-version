...
what_is_not_actually_in_field = []
all_fields = ["1", "2", "3", "4", "5", "6", "7", "8", "9"]
free_digit = None
if free_digit not in what_is_actually_in_field and free_digit in all_fields:
   what_is_not_actually_in_field.appen(free_digit)
